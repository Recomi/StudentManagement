...
public class CircleActivity extends MySwipeBackActivity implements View.OnClickListener {
    @BindView(R.id.rv)
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++){
                        ...
                        String headIconUrl = jsonArray.getJSONObject(i).getString("headIconUrl");
                        int like = jsonArray.getJSONObject(i).getInt("like");
                        int collect = jsonArray.getJSONObject(i).getInt("collect");
                        int share = jsonArray.getJSONObject(i).getInt("share");
